...
public class CensusAnalyser<T> {
    ...
    public CensusAnalyser() {
        ...
        this.fields.put(FieldsToSort.areaInSqKm, Comparator.comparing(census -> census.areaInSqKms, Comparator.reverseOrder()));
        this.fields.put(FieldsToSort.densityPerSqKm, Comparator.comparing(census -> census.densityPerSqKms, Comparator.reverseOrder()));
    }
