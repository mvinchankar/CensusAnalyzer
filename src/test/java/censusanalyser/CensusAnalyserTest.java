...
public class CensusAnalyserTest {
    ...
    public void givenIndiaCensusData_WithWrongFile_ShouldThrowException() {
        try {
            ...
            censusAnalyser.loadIndiaCensusData(WRONG_CSV_FILE_PATH,IndiaStateCodeCSV.class);
        } catch (CensusAnalyserException e) {
    ...
    public void givenStateCSV_ShouldReturnExactCount() {
        ...
        try {
            numOfStateCode = censusAnalyser.loadIndiaCensusData(INDIA_STATE_CSV_PATH,IndiaStateCodeCSV.class);
